...
enum EPlugDataType : int8_t { DT_ENUM, DT_TEXT, DT_MIDI2, DT_MIDI = DT_MIDI2, DT_DOUBLE, DT_BOOL, DT_FSAMPLE, DT_FLOAT, DT_VST_PARAM, DT_INT, DT_INT64, DT_BLOB, DT_NONE=-1 };  //plug datatype
...
// DON'T EXPOSE AS PLUG (TO SAVE SPACE), see IO_MINIMISED
...
// minimised (not exposed on structure view (only properties window), see IO_PARAMETER_SCREEN_ONLY
