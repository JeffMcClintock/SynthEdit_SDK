...
#include "KorgThreeFiveHPFmkII.h"
...
*/
CKorgThreeFiveHPFmkII::CKorgThreeFiveHPFmkII()
{
	...
	m_PlugInName = "KorgThreeFiveHPFmkII";
...
*/
CKorgThreeFiveHPFmkII::~CKorgThreeFiveHPFmkII(void)
{
...
*/
bool __stdcall CKorgThreeFiveHPFmkII::initialize()
{
	// Add your code here
...
{	
	...
	m_HPF3.m_fBeta = -1.0*G/(1.0 + g);
	m_LPF1.m_fBeta = 1.0/(1.0 + g);
...
double CKorgThreeFiveHPFmkII::doFilter(double xn)
{
	...
	double S35H = m_HPF3.getFeedbackOutput() + m_LPF1.getFeedbackOutput();

	// y = G35x + S35
	double u = alpha0*(y1 + S35H);
...
*/
bool __stdcall CKorgThreeFiveHPFmkII::processAudioFrame(float* pInputBuffer, float* pOutputBuffer, UINT uNumInputChannels, UINT uNumOutputChannels)
{
	// output = input -- change this for meaningful processing
	//
	// Do LEFT (MONO) Channel; there is always at least one input/one output
	// (INSERT Effect)
	pOutputBuffer[0] = doFilter(pInputBuffer[0]);
...
//
bool __stdcall CKorgThreeFiveHPFmkII::userInterfaceChange(int nControlIndex)
{
...
*/
bool __stdcall CKorgThreeFiveHPFmkII::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD, float fACMix, float fBDMix)
{
	// add your code here
...
*/
bool __stdcall CKorgThreeFiveHPFmkII::processRackAFXAudioBuffer(float* pInputBuffer, float* pOutputBuffer,
...
*/
bool __stdcall CKorgThreeFiveHPFmkII::processVSTAudioBuffer(float** inBuffer, float** outBuffer, UINT uNumChannels, int inFramesToProcess)
{
...
bool __stdcall CKorgThreeFiveHPFmkII::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity)
{
	return true;
}

bool __stdcall CKorgThreeFiveHPFmkII::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff)
{
	return true;
}

// uModValue = 0->127
bool __stdcall CKorgThreeFiveHPFmkII::midiModWheel(UINT uChannel, UINT uModValue)
{
	return true;
}
...
bool __stdcall CKorgThreeFiveHPFmkII::midiPitchBend(UINT uChannel, int nActualPitchBendValue, float fNormalizedPitchBendValue)
{
	return true;
}
...
*/
bool __stdcall CKorgThreeFiveHPFmkII::midiClock()
{
...
bool __stdcall CKorgThreeFiveHPFmkII::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
bool __stdcall CKorgThreeFiveHPFmkII::initUI()
{
	// ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! ------------------------------ //
...
// **--0xDEA7--**
	...
	ui3.m_pUserCookedUINTData = &m_uNonLinearProcessing;
	ui3.cControlUnits = "                                                                ";
	ui3.cVariableName = "m_uNonLinearProcessing";
