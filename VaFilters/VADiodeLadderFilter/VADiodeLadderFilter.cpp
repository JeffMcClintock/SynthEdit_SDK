...
CVADiodeLadderFilter::CVADiodeLadderFilter()
{
	...
	m_PlugInName = "VADiodeLadderFilter";
...
*/
bool __stdcall CVADiodeLadderFilter::initialize()
{
	// Add your code here
...
//
bool __stdcall CVADiodeLadderFilter::userInterfaceChange(int nControlIndex)
{
	// decode the control index, or delete the switch and use brute force calls
	switch(nControlIndex)
	{
		// if either of these controls change, update all
		case 0:
		case 1:
		{
			updateFilter();
...
*/
bool __stdcall CVADiodeLadderFilter::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD, float fACMix, float fBDMix)
{
	// add your code here
...
*/
bool __stdcall CVADiodeLadderFilter::processRackAFXAudioBuffer(float* pInputBuffer, float* pOutputBuffer,
...
bool __stdcall CVADiodeLadderFilter::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity)
{
	return true;
}

bool __stdcall CVADiodeLadderFilter::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff)
{
	return true;
}

// uModValue = 0->127
bool __stdcall CVADiodeLadderFilter::midiModWheel(UINT uChannel, UINT uModValue)
{
	return true;
}
...
bool __stdcall CVADiodeLadderFilter::midiPitchBend(UINT uChannel, int nActualPitchBendValue, float fNormalizedPitchBendValue)
{
	return true;
}
...
*/
bool __stdcall CVADiodeLadderFilter::midiClock()
{
...
bool __stdcall CVADiodeLadderFilter::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
bool __stdcall CVADiodeLadderFilter::initUI()
{
	// ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! ------------------------------ //
...
// **--0xDEA7--**
	...
	ui1.fUserDisplayDataHiLimit = 17.000000;
	...
	ui3.m_pUserCookedUINTData = &m_NonLinearProcessing;
	ui3.cControlUnits = "                                                                ";
	ui3.cVariableName = "m_NonLinearProcessing";
	...
	ui4.m_pUserCookedUINTData = &m_uNLPType;
	ui4.cControlUnits = "                                                                ";
	ui4.cVariableName = "m_uNLPType";
	ui4.cEnumeratedList = "NORM,REG";
