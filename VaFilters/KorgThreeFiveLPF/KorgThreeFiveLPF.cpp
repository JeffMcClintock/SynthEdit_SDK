...
*/
bool __stdcall CKorgThreeFiveLPF::initialize()
{
	// Add your code here
...
*/
bool __stdcall CKorgThreeFiveLPF::processAudioFrame(float* pInputBuffer, float* pOutputBuffer, UINT uNumInputChannels, UINT uNumOutputChannels)
{
...
//
bool __stdcall CKorgThreeFiveLPF::userInterfaceChange(int nControlIndex)
{
	// decode the control index, or delete the switch and use brute force calls
	// decode the control index, or delete the switch and use brute force calls
	switch(nControlIndex)
	{
		// update if Fc or K changes
		case 0:
		case 1:
		{
			updateFilters();
...
*/
bool __stdcall CKorgThreeFiveLPF::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD, float fACMix, float fBDMix)
{
	// add your code here
...
*/
bool __stdcall CKorgThreeFiveLPF::processRackAFXAudioBuffer(float* pInputBuffer, float* pOutputBuffer,
...
*/
bool __stdcall CKorgThreeFiveLPF::processVSTAudioBuffer(float** inBuffer, float** outBuffer, UINT uNumChannels, int inFramesToProcess)
{
...
bool __stdcall CKorgThreeFiveLPF::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity)
{
	return true;
}

bool __stdcall CKorgThreeFiveLPF::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff)
{
	return true;
}

// uModValue = 0->127
bool __stdcall CKorgThreeFiveLPF::midiModWheel(UINT uChannel, UINT uModValue)
{
	return true;
}
...
bool __stdcall CKorgThreeFiveLPF::midiPitchBend(UINT uChannel, int nActualPitchBendValue, float fNormalizedPitchBendValue)
{
	return true;
}
...
*/
bool __stdcall CKorgThreeFiveLPF::midiClock()
{
...
bool __stdcall CKorgThreeFiveLPF::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
bool __stdcall CKorgThreeFiveLPF::initUI()
{
	// ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! ------------------------------ //
...
// **--0xDEA7--**
	...
	ui0.fUserDisplayDataLoLimit = 50.000000;
	ui0.fUserDisplayDataHiLimit = 22050.000000;
