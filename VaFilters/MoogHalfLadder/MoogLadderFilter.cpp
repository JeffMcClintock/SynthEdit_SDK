...
*/
bool __stdcall CMoogLadderFilter::initialize()
{
	// Add your code here
...
*/
bool __stdcall CMoogLadderFilter::processAudioFrame(float* pInputBuffer, float* pOutputBuffer, UINT uNumInputChannels, UINT uNumOutputChannels)
{
	...
	if(m_uModel == HALF)
	{
		SM = m_LPF1.getFeedbackOutput() + m_LPF2.getFeedbackOutput() + m_APF1.getFeedbackOutput();
	}
...
//
bool __stdcall CMoogLadderFilter::userInterfaceChange(int nControlIndex)
{
...
*/
bool __stdcall CMoogLadderFilter::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD, float fACMix, float fBDMix)
{
	// add your code here
...
*/
bool __stdcall CMoogLadderFilter::processRackAFXAudioBuffer(float* pInputBuffer, float* pOutputBuffer,
...
*/
bool __stdcall CMoogLadderFilter::processVSTAudioBuffer(float** inBuffer, float** outBuffer, UINT uNumChannels, int inFramesToProcess)
{
...
bool __stdcall CMoogLadderFilter::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity)
{
	return true;
}

bool __stdcall CMoogLadderFilter::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff)
{
	return true;
}

// uModValue = 0->127
bool __stdcall CMoogLadderFilter::midiModWheel(UINT uChannel, UINT uModValue)
{
	return true;
}
...
bool __stdcall CMoogLadderFilter::midiPitchBend(UINT uChannel, int nActualPitchBendValue, float fNormalizedPitchBendValue)
{
	return true;
}
...
*/
bool __stdcall CMoogLadderFilter::midiClock()
{
...
bool __stdcall CMoogLadderFilter::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
bool __stdcall CMoogLadderFilter::initUI()
{
	// ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! ------------------------------ //
...
// **--0xDEA7--**
	...
	ui2.m_pUserCookedUINTData = &m_uNLP;
	ui2.cControlUnits = "";
	ui2.cVariableName = "m_uNLP";
	...
	ui3.m_pUserCookedUINTData = &m_uModel;
	ui3.cControlUnits = "";
	ui3.cVariableName = "m_uModel";
	ui3.cEnumeratedList = "FULL,HALF";
