	...
	, cachedGdiPlusFontPadding(-100,-100)
{
	...
	_stringFormat.SetFormatFlags(Gdiplus::StringFormatFlagsNoClip | Gdiplus::StringFormatFlagsMeasureTrailingSpaces); // Don't clip to rect like DirectDraw.
...
#pragma pop_macro("new")
	...
	return cachedGdiPlusFontPadding;
		...
		void GraphicsContext_base::DrawTextU(const char* utf8String, int32_t stringLength, const GmpiDrawing_API::IMpTextFormat* textFormat, const GmpiDrawing_API::MP1_RECT* layoutRect, const GmpiDrawing_API::IMpBrush* brush, int32_t flags)
		{
			...
			//	auto& b = ((PGCC_solidColorBrush*)brush)->Brush;
		...
		int32_t GraphicsContext_base::CreateSolidColorBrush(const GmpiDrawing_API::MP1_COLOR* color, GmpiDrawing_API::IMpSolidColorBrush **solidColorBrush)
		{
			*solidColorBrush = 0;
			...
			//auto b2 = new PGCC_solidColorBrush( color );
			//b2->query Interface(gmpi_gui::SE_IID_GRAPHICS_SOLIDCOLORBRUSH, reinterpre t_cast<void**>(solidColorBrush));
			//b2->rele ase(); // will delete it if don't support expected interface.
		...
		/*
		int32_t PortableGraphicsContext_SE_Composited::CreateBitmap(GmpiDrawing_API::MP1_SIZE_U size, const GmpiDrawing_API::MP1_BITMAP_PROPERTIES* bitmapProperties, GmpiDrawing_API::IMpBitmap** bitmap)
		{
		*bitmap = nullptr;

		gmpi_sdk::mp_shared_ptr<gmpi::IMpUnknown> b2;
		b2.Attach(new PGCC_bitmap(size.width, size.height));
		...
		*/
		...
		//void PortableGraphicsContext_SE_Composited::DrawRectangle(const GmpiDrawing::Rect& rect, GmpiDrawing_API::IMpBrush* brush, float strokeWidth, gmpi_gui::IStrokeStyle* strokeStyle)
		...
		//void PortableGraphicsContext_SE_Composited::FillRectangle(const GmpiDrawing::Rect& rect, GmpiDrawing_API::IMpBrush* brush)
		...
		//void PortableGraphicsContext_SE_Composited::DrawLine(GmpiDrawing::Point point0, GmpiDrawing::Point point1, GmpiDrawing_API::IMpBrush* brush, float strokeWidth, gmpi_gui::IStrokeStyle* strokeStyle)
		...
		void GraphicsContext_base::DrawGeometry(const GmpiDrawing_API::IMpPathGeometry* geometry, const GmpiDrawing_API::IMpBrush* brush, float strokeWidth, const GmpiDrawing_API::IMpStrokeStyle* strokeStyle)
		{
			...
			if (solidBrush)
			{
				...
				if (pg)
				{
					...
					for( auto p : pg->points_ )
					{
					points.push_back(Gdiplus::PointF(p.x / * * dpiScale_* /, p.y /* * dpiScale_* /));
					}

					if (pg->closed_ && points.size() > 0)
					{
